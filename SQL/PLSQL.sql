...
INSERT INTO food VALUES (4,'Spahget', 'Noodles and sauce');
...
Can call functions/procedures                               CANNOT call procedures
...
BEGIN
    ...
    insert_food_null_id('jaw breaker3','only a quarter');
END;
/
