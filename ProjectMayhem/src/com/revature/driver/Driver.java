...
public class Driver {
	 ...
	 *
	 * package - all lower case, separated by periods constants - ALL_CAPS_LOLZ
	 */
	...
	public static void main(String[] args) {
		 ...
		 * Instance variables- property belongs to specific object Static variables-
		 * belong to class/all instances Instance methods- behavior related to a
		 * specific object Static methods - relative to the entire class Constructors-
		 * instantiates the class using the keyword "new"
		 */
		Person p = new Person();
		p.setName("Jim");
